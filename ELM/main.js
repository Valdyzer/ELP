...
var $author$project$Main$Model = F7(
	function (http, jSon, listWord, word, listIntro, inputContent, title) {
		return {http: http, inputContent: inputContent, jSon: jSon, listIntro: listIntro, listWord: listWord, title: title, word: word};
	});
...
var $author$project$Main$getWordsFromFile = $elm$http$Http$get(
	{
		expect: $elm$http$Http$expectString($author$project$Main$GotText),
		url: 'http://localhost:8000/static/thousand_words_things_explainer.txt'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A7($author$project$Main$Model, $author$project$Main$Loading, $author$project$Main$Loading, '', '', _List_Nil, '', 'Guess it !'),
		$author$project$Main$getWordsFromFile);
};
...
var $author$project$Main$Word = function (a) {
	return {$: 'Word', a: a};
};
...
var $author$project$Main$Intro = F2(
...
var $author$project$Main$introDecoder = A3(
	$elm$json$Json$Decode$map2,
...
var $author$project$Main$defDecoder = $elm$json$Json$Decode$list($author$project$Main$introDecoder);
...
var $author$project$Main$getDefFromWord = function (mot) {
	...
	function (msg, model) {
		switch (msg.$) {
			case 'GotText':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var allWords = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{http: $author$project$Main$Success, listWord: allWords}),
						A2(
							$elm$random$Random$generate,
							$author$project$Main$Word,
							$elm_community$random_extra$Random$List$choose(
								A2($elm$core$String$split, ' ', allWords))));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{http: $author$project$Main$Failure}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Word':
				var maybe = msg.a;
				if (maybe.a.$ === 'Just') {
					var randomWord = maybe.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{word: randomWord}),
						$author$project$Main$getDefFromWord(randomWord));
				} else {
					var _v3 = maybe.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'GotDef':
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{jSon: $author$project$Main$Success, listIntro: data}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{jSon: $author$project$Main$Failure}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Fill':
			...
			default:
				var word = msg.a;
				return _Utils_eq(model.title, model.word) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{title: 'Guess It !'}),
...
var $author$project$Main$Fill = function (a) {
	return {$: 'Fill', a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'font-family', 'avenir')
				]),
			_List_fromArray(
				[
					stateText,
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$placeholder('Try to find me'),
							$elm$html$Html$Attributes$value(model.inputContent),
							$elm$html$Html$Events$onInput($author$project$Main$Fill)
						]),
					_List_Nil),
					_Utils_eq(
					$elm$core$String$toLower(model.inputContent),
					$elm$core$String$toLower(model.word)) ? A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$src('http://localhost:8000/static/derek-aaron-ruell-napoleon-dynamite.gif')
								]),
							_List_Nil)
						])) : A2(
					$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							$author$project$Main$Click(model.word))
						]),
					_List_fromArray(
						[
...
var $author$project$Main$viewDefinition = function (def) {
	if (!def.b) {
		...
		return _Utils_ap(
			...
			$author$project$Main$viewDefinition(xs));
	}
};
var $author$project$Main$viewMeaning = function (mean) {
	if (!mean.b) {
		return _List_Nil;
	} else {
		var x = mean.a;
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(x.partOfSpeech)
						]))
				]),
			_Utils_ap(
				_List_fromArray(
					[
						...
						$elm$html$Html$ol,
						_List_Nil,
						$author$project$Main$viewDefinition(x.definitions))
					]),
				$author$project$Main$viewMeaning(xs)));
	}
};
var $author$project$Main$viewIntro = function (listIntro) {
	if (!listIntro.b) {
		return _List_Nil;
	} else {
		var x = listIntro.a;
		var xs = listIntro.b;
		return _Utils_ap(
			$author$project$Main$viewMeaning(x.meanings),
			$author$project$Main$viewIntro(xs));
	}
};
					...
					switch (_v1.$) {
						...
						default:
							return A2(
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'padding-left', '300px'),
										A2($elm$html$Html$Attributes$style, 'padding-right', '300px'),
									...
									[
										...
										_List_fromArray(
											[
												...
												_Utils_eq(
													$elm$core$String$toLower(model.inputContent),
													$elm$core$String$toLower(model.word)) ? model.word : model.title)
											])),
										A2(
										$elm$html$Html$ul,
										_List_fromArray(
										...
										$author$project$Main$viewIntro(model.listIntro))
									]));
					}
				}());
	}
