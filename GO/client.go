...
func main() {
	connectFlag = true
	//pathToFile = /pathtomatrixfiles        to run, uncomment this line and replace /pathtomatrixfiles with the path to the directory containing the matrix files
	...
	for connectFlag {
		...
		file, err := os.Open(pathToFile + matrixSize[srcFile-1] + ".txt")
